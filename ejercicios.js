...
// Ejercicio 5
console.log(null);
console.log("Ejercicio 5.1: Ejecucion de codigo si es mayor a 10 y menor que 18:");
if(edad >= 10 && edad <= 18){
...
// Ejercicio 6
console.log(null);
console.log("Ejercicio 6: Ejecucion de codigo si es mayor a 10 y menor que 18");
console.log("es mayor que 5 Y menor que 10:");
...
if(edad >= 18 || tienePermiso){
    console.log("Usuario cumple con requisito +18");
}
